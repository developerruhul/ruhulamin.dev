      ...
      <div className="container section-margin-top">
        ...
        <article className="mb-10 mt-16 prose prose-lg prose-purple">
          ...
          <div className="max-w-4xl text-lg font-medium text-gray-600 sm:leading-9">
            <p>
              I'm a freelance "Fullstack web developer" with 2 years of experience. I mostly work with ReactJS in the
              frontend and NodeJS in the backend. I began my career as a
              frontend developer and I picked up backend skills along the way.
            </p>
            <p>
              I develop outstanding frontend websites and webapps with beautiful
              and smooth user interfaces but I'm also able to develop the
              backend and then integrate the two(website and API) to create a
          ...
          <ul>
            ...
            <li>
              ...
              <em>
                Node.js, Express, Graphql, Prisma, MongoDB, MySQL, Next.js.
              </em>
            </li>
          </ul>
          <p>
            I always keep myself up to date with the everchanging tech industry.
            I can quickly integrate with any tech stack and have experience
            using all major state management and styling paradigms.
          </p>
          ...
          <ul>
            <li>
              ...
              <em>
                ...
                rates. I build websites that are responsive and provide great
                user experience in almost all kinds of devices with various
                screen sizes.
              </em>
            </li>
            <li>
