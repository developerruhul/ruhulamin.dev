...
const Footer = () => {
  return (
    <footer className='footer justify-self-start bg-gray-50 pt-16 pb-12 sm:pt-20'>
          ...
          <article className='space-y-5'>
            ...
            <ul className='space-y-4'>
              <li className="hover:text-gray-900 transition-colors duration-200 tracking-tight font-medium">
                <a target="_blank" href='https://twitter.com/developerruhul'>Twitter</a>
              </li>
              <li className="hover:text-gray-900 transition-colors duration-200 tracking-tight font-medium">
                <a target="_blank" href='https://github.com/developerruhul'>Github</a>
              </li>
              <li className="hover:text-gray-900 transition-colors duration-200 tracking-tight font-medium">
                <a target="_blank" href='https://www.linkedin.com/in/developerruhul/'>
                  LinkedIn
                </a>
              </li>
              <li className="hover:text-gray-900 transition-colors duration-200 tracking-tight font-medium">
                <a target="_blank" href='https://facebook.com/developerruhul/'>Facebook</a>
              </li>
              <li className="hover:text-gray-900 transition-colors duration-200 tracking-tight font-medium">
                <a target="_blank" href='https://blog.ruhulamin.dev'>Blog</a>
              </li>
            </ul>
          </article>
